set -gx CONDA_EXE (cygpath "C:/ProgramData/Miniconda2\Scripts\conda.exe")
set _CONDA_ROOT (cygpath "C:/ProgramData/Miniconda2")
set _CONDA_EXE (cygpath "C:/ProgramData/Miniconda2\Scripts\conda.exe")
set -gx CONDA_PYTHON_EXE (cygpath "C:/ProgramData/Miniconda2\python.exe")
